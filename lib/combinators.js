(function() {
  var If, Lazy, LazyEval, Let, p, secret_tag_value, sys, wrap;
  ...
  LazyEval.prototype.force = function(object, callback) {
    return (typeof object !== "undefined" && object !== null) && object.lazy === secret_tag_value ? object(__bind(function(error, result) {
      return error ? this.raise(error) : callback(result);
